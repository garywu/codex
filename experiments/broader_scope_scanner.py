...
class BroaderScopeScanner:
    ...
    def _looks_like_python_project(self, directory: Path) -> bool:
        ...
        indicators = ["pyproject.toml", "setup.py", "requirements.txt", "Pipfile", "poetry.lock", "__init__.py"]
    ...
    def _create_aggregate_report(self) -> dict:
        ...
        aggregate_priority = {"CRITICAL": 0, "MANDATORY": 0, "HIGH": 0, "MEDIUM": 0, "LOW": 0}
        ...
        report = {
            ...
            "effectiveness_metrics": {
                "projects_clean_percentage": ((total_projects - projects_with_violations) / max(total_projects, 1))
                * 100,
