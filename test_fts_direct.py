...
def test_fts_database():
    ...
    for pattern in test_patterns:
        ...
        """, (
            pattern.name, pattern.category, pattern.priority, pattern.description,
            pattern.detection_pattern, pattern.fix_template, pattern.rationale,
            pattern.example_good, pattern.example_bad, pattern.replaces,
