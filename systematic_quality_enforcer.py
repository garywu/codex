...
class SystematicQualityEnforcer:
            ...
            if 'def ' in original_line:
                ...
                if match:
                    ...
                    if not old_name.startswith('mock_'):
                        ...
                        warning_line = ' ' * (indent + 4) + f'logging.warning("⚠️ MOCK: Using {new_name} - not for production")\n'
    ...
    def _create_enforcement_report(self, scan_results: Dict[str, Any], fix_results: Dict[str, Any], validation_results: Dict[str, Any]) -> str:
