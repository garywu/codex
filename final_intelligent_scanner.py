...
class FinalIntelligentScanner:
    ...
    def _intelligent_print_analysis(self, file_path: Path, line_num: int, line: str, context: Dict[str, Any]) -> Dict[str, Any] | None:
    ...
    def _intelligent_path_analysis(self, file_path: Path, line_num: int, line: str, context: Dict[str, Any]) -> Dict[str, Any] | None:
