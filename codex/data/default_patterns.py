...
DEFAULT_PATTERNS = [
    # ============ MANDATORY PATTERNS ============
    {
        ...
        "detection": {"keywords": ["__init__.py", "nested", "subdirectory"], "regex": ".*/__init__\\.py"},
        "fix": {"template": "Move modules to flat structure under main package directory", "complexity": "medium"},
        "examples": {
    ...
    },
    {
        ...
        "fix": {"template": "Replace with: uv add <package>", "complexity": "simple"},
        "examples": {"good": "uv add fastapi[all]", "bad": "pip install fastapi"},
    ...
    },
    {
        ...
        "fix": {"template": "Fix all issues before committing", "complexity": "medium"},
        "examples": {"good": "Clean code that passes all hooks", "bad": "# TODO: fix this later\\n# noqa: F401"},
    ...
    },
    {
        ...
        "detection": {"keywords": ["except:", "bare except"], "regex": "except\\s*:"},
        "fix": {"template": "except Exception:", "complexity": "simple", "auto_fixable": True},
        "examples": {"good": "except ValueError:\\n    handle_error()", "bad": "except:\\n    pass"},
    ...
    },
    {
        ...
        "fix": {"template": "Use os.environ.get('JWT_SECRET')", "complexity": "simple"},
        "examples": {"good": "jwt_secret = os.environ.get('JWT_SECRET')", "bad": "jwt_secret = 'hardcoded-secret-key'"},
    ...
    # ============ HIGH PRIORITY PATTERNS ============
    {
        ...
        "fix": {"template": "Use: gh pr create, gh issue create, gh repo clone", "complexity": "simple"},
        "examples": {"good": "gh pr create --title 'Feature: Add component'", "bad": "git push origin feature-branch"},
    ...
    },
    {
        ...
        "fix": {"template": "Rename to mock_ prefix: mock_user_data, mock_api_response", "complexity": "simple"},
        "examples": {"good": "mock_user_data = {...}", "bad": "fake_user_data = {...}"},
    ...
    },
    {
        ...
        "fix": {"template": "logger.info({'event': 'action', 'details': data})", "complexity": "medium"},
        "examples": {
    ...
    },
    {
        ...
        "category": "logging",
        "priority": "HIGH",
        "description": "Replace logging.info()() with proper logging",
        "rule": "Never use logging.info()() in production code",
        "rationale": "Print statements bypass logging infrastructure",
        "detection": {"keywords": ["logging.info("], "regex": "^\\s*print\\("},
        "fix": {"template": "logger.info(...)", "complexity": "simple", "auto_fixable": True},
        "examples": {"good": "logger.info('Processing started')", "bad": "logging.info('Processing started')"},
