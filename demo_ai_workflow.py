...
def show_cli_commands():
    ...
    commands = [
        ...
        ("# Step 2: Get overview of all issues",
         'codex query-db demo_scan.db "Show me all violations"'),
        
        ("# Step 3: Identify worst files",
         'codex query-db demo_scan.db "What files have the most violations?"'),
        
        ("# Step 4: Get prioritized fix list",
         'codex query-db demo_scan.db "What should I fix first?"'),
        
        ("# Step 5: Find quick wins",
         'codex query-db demo_scan.db "Show me simple fixes"'),
        
        ("# Step 6: Security focus",
         'codex query-db demo_scan.db "Show me violations related to security"'),
        
        ("# Step 7: Get learning insights",
         'codex query-db demo_scan.db "Help me learn from this codebase"'),
        
        ("# Step 8: AI-formatted output for Claude",
         'codex query-db demo_scan.db "Show me repository insights" --ai'),
        
        ("# Step 9: Understand the analysis",
         'codex query-db demo_scan.db "Count violations" --explain'),
        
        ("# Step 10: Get help with queries",
         "codex db-help")
    ]
...
def show_benefits():
    ...
    benefits = [
        ("🔍 Natural Language Queries", "Claude can ask questions in natural language and get structured, queryable results"),
        ("🧠 Contextual Understanding", "AI gets rich context about violations, confidence scores, and business impact"),
        ("⚡ Interactive Analysis", "Real-time querying allows for conversational code improvement workflows"), 
        ("🎯 Prioritized Recommendations", "AI can intelligently prioritize fixes based on severity, confidence, and complexity"),
