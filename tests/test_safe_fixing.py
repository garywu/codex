...
from codex.safe_fixer import SafeFixer, import_validator, indentation_validator, syntax_validator
...
class TestSafeFixer(unittest.TestCase):
    ...
    def test_fix_breaks_syntax(self):
        ...
        success, attempt = self.fixer.apply_fix_safely(test_file, bad_fix, "test-pattern", line_number=1)
...
class TestFixSafetyAnalyzer(unittest.TestCase):
    ...
    def test_never_auto_fix_patterns(self):
        ...
        is_safe, reason = analyzer.is_fix_safe("secure-jwt-storage", "auth/handler.py", "JWT_SECRET = 'hardcoded'")
    ...
    def test_protected_files(self):
        ...
        is_safe, reason = analyzer.is_fix_safe("mock-code-naming", "project/__init__.py", "def test():")
    ...
    def test_critical_path_detection(self):
        ...
        is_safe, reason = analyzer.is_fix_safe(
            "use-uv-package-manager", "security/auth_module.py", "pip install requests"
        )
    ...
    def test_safe_pattern_in_test_file(self):
        ...
        is_safe, reason = analyzer.is_fix_safe("mock-code-naming", "tests/test_example.py", "def fake_function():")
    ...
    def test_dangerous_keywords_detection(self):
        ...
        is_safe, reason = analyzer.is_fix_safe("use-uv-package-manager", "script.py", "eval(user_input)")
